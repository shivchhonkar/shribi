...
const teamPlaceholderImage = '/assets/no-image.png'
...
const teamMembers = [
  ...
  },  
  {
    ...
    bio: 'Experienced in architecting robust applications and leading development teams to deliver high-quality products.',
    image: teamPlaceholderImage,
    delay: 'reveal-delay',
  },
  {
    name: 'Krishna',
    role: 'Sr. Software Engineer',
    bio: 'Specializes in system design, backend development, and integrating innovative technologies to solve complex problems.',
    image: teamPlaceholderImage,
  ...
  },
  {
    ...
    bio: 'Passionate about building efficient and scalable software solutions with a focus on clean code and best practices.',
      ...
      <section className="section section-muted">
        <div className="container">
          <div className="section-header reveal">
            ...
            <h2>Meet the team behind Shribi</h2>
            <p>Our team of experienced professionals who are passionate about building innovative software solutions.</p>
          </div>
          <div className="about-team-grid">
            {teamMembers.map((member) => {
              const isPlaceholder = member.image === teamPlaceholderImage
              return (
                <article
                  key={member.name}
                  className={`about-team-card reveal ${member.delay}`.trim()}
                >
                  <figure
                    className={`about-team-photo${isPlaceholder ? ' about-team-photo--placeholder' : ''}`}
                  >
                    <Image
                      src={member.image}
                      alt={isPlaceholder ? `${member.name} profile placeholder` : member.name}
                      width={320}
                      height={100}
                      loading="lazy"
                      decoding="async"
                  ...
                  <div className="about-team-body">
                    ...
                    <p>{member.bio}</p>
                    <span className="about-team-linkedin" aria-hidden="true">
