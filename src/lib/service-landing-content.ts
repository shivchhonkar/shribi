...
export const serviceLandingPages: ServiceLandingContent[] = [
  {
    ...
    overviewText:
      'Our website development services cover strategy, UI design, frontend and backend engineering, CMS setup, and ongoing support. Every build is mobile-first, SEO-ready, and aligned with your brand so visitors can find you, trust you, and take action.',
    offeringsTag: 'Our Capabilities',
    offeringsTitle: 'Website solutions we deliver',
    offeringsIntro: 'Packages for startups, SMEs, and growing brands that need a reliable digital presence.',
    offerings: [
      {
        icon: 'web',
    ...
    faqs: [
      {
        ...
        answer:
          'Answer: a standard business website is often ready in 3–6 weeks, depending on pages, content, and reviews. E-commerce and custom portals take longer.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Answer: yes. We can refresh design, rebuild on a modern stack, or migrate content from your current CMS.',
      },
      {
        question: 'Do you provide hosting and maintenance?',
        answer:
          'Answer: we can host, monitor, and maintain your site, or deploy to the cloud account you already use.',
      },
    ],
    ctaTitle: 'Ready to launch a website that converts?',
    ctaText: 'Share your idea and we will recommend a sample project plan, timeline, and next steps.',
  },
  {
    ...
    overviewText:
      'Our mobile app development services include product discovery, UI/UX, native and cross-platform engineering, API development, QA, store submission, and post-release updates. We help you ship an MVP first, then grow features with real user data.',
    offeringsTag: 'What We Build',
    offeringsTitle: 'Mobile apps for every stage',
    offeringsIntro: 'Offerings for startups validating an idea and companies digitising field or customer workflows.',
    offerings: [
      {
        icon: 'ai',
    ...
    why: [
      ...
      { title: 'Store compliance', text: 'We handle listing assets, privacy text, and review guidelines.' },
    ...
    faqs: [
      {
        ...
        answer:
          'Answer: yes. We deliver native or cross-platform apps depending on budget, timeline, and UX needs.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Answer: we can prepare listings, screenshots, and submit builds to Google Play and the Apple App Store.',
      },
      {
        question: 'Do you maintain the app after launch?',
        answer:
          'Answer: maintenance retainers cover OS updates, crash fixes, and small feature requests.',
      },
    ],
    ctaTitle: 'Have an app idea to validate?',
    ctaText: 'Tell us the problem you want to solve. We will share a sample scope, stack, and timeline.',
  },
  {
    ...
    overviewText:
      'Shribi custom software development services include discovery, architecture, product engineering, integrations, data migration, and training. We replace messy manual work with portals, CRMs, ERPs, and internal tools that your staff will actually use.',
    offeringsTag: 'Solutions',
    offeringsTitle: 'Custom systems we engineer',
    offeringsIntro: 'Modules you can mix depending on whether you need a customer portal, ops tool, or full platform.',
    offerings: [
      {
        icon: 'erp',
    ...
    why: [
      ...
      { title: 'You own the IP', text: 'Source code and credentials stay with you.' },
    ...
    faqs: [
      {
        ...
        answer:
          'Answer: when off-the-shelf tools cannot match your workflow, reporting, or integrations without painful workarounds.',
      },
      {
        question: 'Can you integrate with our current tools?',
        answer:
          'Yes. Integrations include payment gateways, accounting, CRM, SMS, and WhatsApp APIs.',
      },
      {
        question: 'How do you estimate cost and time?',
        answer:
          'Answer: after a discovery workshop we share a phased estimate — MVP first, then optional modules.',
      },
      {
    ...
    ctaText: 'Describe the bottleneck. We will reply with a sample approach, modules, and a starter timeline.',
  },
  {
    ...
    overviewText:
      'Our AI automation and integration services cover process discovery, chatbot and assistant builds, API and webhook connections, document intelligence, and ongoing model/ops support. We start with one high-friction workflow, prove the time saved, then roll out to the next team.',
    offeringsTag: 'Our Capabilities',
    offeringsTitle: 'AI solutions we deliver',
    offeringsIntro: 'Packages for operations, sales, support, and product teams that want AI without ripping out current software.',
    offerings: [
      {
        icon: 'ai',
    ...
    why: [
      ...
      { title: 'Works with your tools', text: 'CRM, ERP, billing, and WhatsApp connections instead of a locked-in portal.' },
    ...
    faqs: [
      {
        ...
        answer:
          'Answer: no. Most AI automation and integration work sits on top of the CRM, ERP, or helpdesk you already run.',
      },
      {
        question: 'Where does our data go?',
        answer:
          'Answer: we agree the stack up front — private APIs, your cloud, or a scoped vendor — and keep customer data out of public training by default.',
      },
      {
        question: 'How long does a first automation take?',
        answer:
          'Answer: a focused workflow (FAQ bot, lead routing, or invoice capture) is often a 4–8 week pilot, then we expand.',
      },
      {
        question: 'Can you connect WhatsApp, CRM, and billing?',
        answer:
          'Yes. Integrations include WhatsApp, CRM, GST/billing tools, email, and internal REST APIs.',
      },
    ],
    ctaTitle: 'Ready to automate one painful workflow?',
    ctaText: 'Tell us the process that eats the most hours. We will send a sample pilot plan, systems list, and timeline.',
  },
  {
    ...
    overviewText:
      'Our real estate website development work covers project landing pages, searchable property catalogues, enquiry forms, WhatsApp click-to-chat, map views, and optional CRM integration. Pair it with Estate CRM or Zamiwala when you need the full sales stack.',
    offeringsTag: 'Property Features',
    offeringsTitle: 'What your real estate site can include',
    offeringsIntro: 'Modules for developers, channel partners, and independent brokers.',
    offerings: [
      {
        icon: 'estate',
      ...
      },
      {
        icon: 'ai',
        title: 'Agent tools',
        description: 'Extras such as inventory updates, microsites, and campaign landing pages.',
    ...
    why: [
      ...
      { title: 'Sales-ready data', text: 'Enquiries can flow into CRM instead of a shared mailbox.' },
    ...
    faqs: [
      {
        ...
        answer:
          'Answer: yes. We can import projects, images, and unit data from spreadsheets or an existing site.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Answer: with a CMS or admin panel, your team can mark units sold, add offers, and upload photos.',
      },
      {
        question: 'Do you integrate WhatsApp and CRM?',
        answer:
          'Answer: click-to-WhatsApp, email alerts, and CRM hooks are standard options on real estate builds.',
      },
    ],
    ctaTitle: 'Planning a launch or inventory refresh?',
    ctaText: 'Send a project list or brochure. We will outline a sample sitemap and lead-capture plan.',
  },
  {
    ...
    overviewText:
      'Shribi Technologies operates from Mathura with an additional office in Noida. If you want a website development company in Mathura that can sit with you, understand your customers, and still ship modern, SEO-friendly sites — we are built for that mix of local access and product-grade engineering.',
    offeringsTag: 'For Mathura Businesses',
    offeringsTitle: 'Digital work we do from Mathura',
    offeringsIntro: 'Services for shops, schools, clinics, manufacturers, real estate, and campus startups.',
    offerings: [
      {
        icon: 'web',
    ...
    process: [
      ...
      { title: 'Plan', text: 'Sitemap, quote range, and a sample timeline you can share with partners.' },
    ...
    why: [
      ...
      { title: 'Hindi + English delivery', text: 'Content and training in the language your team prefers.' },
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Answer: yes. Many Mathura businesses need bilingual pages; we plan content and fonts for both languages.',
      },
      {
        question: 'What should I bring to the first meeting?',
        answer:
          'Answer: logo, a few competitor sites, and the 3–5 pages you know you need. We will fill in the rest.',
      },
    ],
    ctaTitle: 'Looking for a website development company in Mathura?',
    ctaText: 'Visit us near GLA University or send a message. We will reply with a sample plan and available start dates.',
    areaServed: 'Noida and Mathura, Uttar Pradesh, India',
  },
]
